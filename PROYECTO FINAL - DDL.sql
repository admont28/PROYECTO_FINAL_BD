...
DESCRIPCION_EVALUACION_AUXILIARES VARCHAR2 (255) NOT NULL,
FECHA_CREACION DATE NOT NULL,
ID_SOLICITANTE VARCHAR2 (20) NOT NULL,
ID_CONVOCATORIA VARCHAR2 (20) UNIQUE NOT NULL,
CONSTRAINT PK_EVALUACION_AUXILIARES PRIMARY KEY (EVALUACION_AUXILIARES_ID),
CONSTRAINT FK_SOLICITANTE_EN_EVALUACION_AUXILIARES FOREIGN KEY (ID_SOLICITANTE) REFERENCES SOLICITANTE (SOLICITANTE_ID),
CONSTRAINT FK_CONVOCATORIA_EN_EVALUACION_AUXILIARES FOREIGN KEY (ID_CONVOCATORIA) REFERENCES CONVOCATORIA (CONVOCATORIA_ID)
);
COMMENT ON TABLE EVALUACION IS 'Es la entidad que contiene los datos de una evaluacion';
COMMENT ON COLUMN EVALUACION_AUXILIARES.EVALUACION_AUXILIARES_ID IS 'Es la llave primaria de la tabla evaluacion';
COMMENT ON COLUMN EVALUACION_AUXILIARES.DESCRIPCION_EVALUACION_AUXILIARES IS 'Es la descripcion de la evaluacion';
...
CONSTRAINT FK_EVALUACION_AUXILIARES_EN_SELECCION_AUXILIARES FOREIGN KEY (ID_EVALUACION_AUXILIARES) REFERENCES EVALUACION_AUXILIARES (EVALUACION_AUXILIARES_ID)
);
...
COMMENT ON COLUMN DETALLE_RESOLUCION.ID_RESOLUCION_AUXILIARES_SELECCIONADOS IS 'Es el campo que identifica la llave foranea de la tabla de resolucion de auxiliares seleccionados.';
...
CREATE TABLE INCONFORMIDAD_AUXILIARES_AUXILIAR(
ID_INCONFORMIDAD_AUXILIARES VARCHAR2 (20) NOT NULL,
ID_AUXILIAR VARCHAR2 (20) NOT NULL,
ID_SOLICITANTE VARCHAR2 (20) NOT NULL,

CONSTRAINT FK_INCONFORMIDAD_AUXILIARES_EN_INCONFORMIDAD_AUXILIARES_AUXILIAR FOREIGN KEY (ID_INCONFORMIDAD_AUXILIARES) REFERENCES INCONFORMIDAD_AUXILIARES (INCONFORMIDAD_AUXILIARES_ID),
CONSTRAINT FK_AUXILIAR_EN_INCONFORMIDAD_AUXILIARES_AUXILIAR FOREIGN KEY (ID_AUXILIAR) REFERENCES AUXILIAR (AUXILIAR_ID),
CONSTRAINT FK_SOLICITANTE_EN_INCONFORMIDAD_AUXILIARES_AUXILIAR FOREIGN KEY (ID_SOLICITANTE) REFERENCES SOLICITANTE (SOLICITANTE_ID)

);

COMMENT ON TABLE INCONFORMIDAD_ES_AUXILIAR IS 'Es la entidad PUENTE que representa la inconformidad de auxiliares con auxiliares.';
COMMENT ON COLUMN INCONFORMIDAD_AUXILIARES_AUXILIAR.ID_INCONFORMIDAD_AUXILIARES IS 'Es el campo que identifica la llave foranea de la tabla inconformidad de auxiliares.';
COMMENT ON COLUMN INCONFORMIDAD_AUXILIARES_AUXILIAR.ID_AUXILIAR IS 'Es el campo que identifica la llave foranea de la tabla auxiliar.';
COMMENT ON COLUMN INCONFORMIDAD_AUXILIARES_AUXILIAR.ID_SOLICITANTE IS 'Es el campo que identifica la llave foranea de la tabla solicitante.';
...
CONSTRAINT PK_INSCRIPCION_CONVOCATORIA PRIMARY KEY (ID_AUXILIAR, ID_SOLICITANTE ),
CONSTRAINT FK_AUXILIAR_EN_INSCRIPCION_CONVOCATORIA FOREIGN KEY (ID_AUXILIAR) REFERENCES AUXILIAR (AUXILIAR_ID),
CONSTRAINT FK_CONVOCATORIA_EN_INSCRIPCION_CONVOCATORIA FOREIGN KEY (ID_CONVOCATORIA) REFERENCES CONVOCATORIA (CONVOCATORIA_ID)
);
