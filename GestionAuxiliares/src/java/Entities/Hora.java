 ...
 */
@Entity
@Table(name = "HORA", catalog = "", schema = "PROYECTO_FINAL", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"HORA_ID"})})
@XmlRootElement
@NamedQueries({
...
public class Hora implements Serializable {
    ...
    public Hora(HoraPK horaPK, String horaId, String horaFin) {
        this.horaPK = horaPK;
        this.horaId = horaId;
