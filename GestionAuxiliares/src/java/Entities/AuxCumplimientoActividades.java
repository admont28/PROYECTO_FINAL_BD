 ...
 */
@Entity
@Table(name = "AUX_CUMPLIMIENTO_ACTIVIDADES", catalog = "", schema = "PROYECTO_FINAL", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"AUX_CUMP_ACTIVIDADES_ID"})})
@XmlRootElement
@NamedQueries({
...
public class AuxCumplimientoActividades implements Serializable {
    ...
    @Column(name = "AUX_CUMP_ACTIVIDADES_ID", nullable = false)
    private BigInteger auxCumpActividadesId;
    ...
    public AuxCumplimientoActividades(AuxCumplimientoActividadesPK auxCumplimientoActividadesPK, BigInteger auxCumpActividadesId) {
        this.auxCumplimientoActividadesPK = auxCumplimientoActividadesPK;
    ...
    public BigInteger getAuxCumpActividadesId() {
        return auxCumpActividadesId;
    }

    public void setAuxCumpActividadesId(BigInteger auxCumpActividadesId) {
        this.auxCumpActividadesId = auxCumpActividadesId;
    }
