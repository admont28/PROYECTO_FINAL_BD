 ...
 */
@Entity
@Table(name = "INC_AUX_AUXILIAR", catalog = "", schema = "PROYECTO_FINAL", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"INC_AUX_AUXILIAR_ID"})})
@XmlRootElement
@NamedQueries({
...
public class IncAuxAuxiliar implements Serializable {
    ...
    @Column(name = "INC_AUX_AUXILIAR_ID", nullable = false)
    private BigInteger incAuxAuxiliarId;
    ...
    public IncAuxAuxiliar(IncAuxAuxiliarPK incAuxAuxiliarPK, BigInteger incAuxAuxiliarId) {
        this.incAuxAuxiliarPK = incAuxAuxiliarPK;
    ...
    public BigInteger getIncAuxAuxiliarId() {
        return incAuxAuxiliarId;
    }

    public void setIncAuxAuxiliarId(BigInteger incAuxAuxiliarId) {
        this.incAuxAuxiliarId = incAuxAuxiliarId;
    }
