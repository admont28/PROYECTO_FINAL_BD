    ...
    public void create(InconformidadAuxiliares inconformidadAuxiliares) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListIncAuxAuxiliar : inconformidadAuxiliares.getIncAuxAuxiliarList()) {
                InconformidadAuxiliares oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListIncAuxAuxiliar = incAuxAuxiliarListIncAuxAuxiliar.getIdInconformidadAuxiliares();
                incAuxAuxiliarListIncAuxAuxiliar.setIdInconformidadAuxiliares(inconformidadAuxiliares);
                incAuxAuxiliarListIncAuxAuxiliar = em.merge(incAuxAuxiliarListIncAuxAuxiliar);
                if (oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListIncAuxAuxiliar != null) {
                    oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListIncAuxAuxiliar.getIncAuxAuxiliarList().remove(incAuxAuxiliarListIncAuxAuxiliar);
                    oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListIncAuxAuxiliar = em.merge(oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListIncAuxAuxiliar);
                }
            }
        ...
        try {
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListOldIncAuxAuxiliar : incAuxAuxiliarListOld) {
                if (!incAuxAuxiliarListNew.contains(incAuxAuxiliarListOldIncAuxAuxiliar)) {
                    ...
                    illegalOrphanMessages.add("You must retain IncAuxAuxiliar " + incAuxAuxiliarListOldIncAuxAuxiliar + " since its idInconformidadAuxiliares field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListNewIncAuxAuxiliar : incAuxAuxiliarListNew) {
                if (!incAuxAuxiliarListOld.contains(incAuxAuxiliarListNewIncAuxAuxiliar)) {
                    InconformidadAuxiliares oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar = incAuxAuxiliarListNewIncAuxAuxiliar.getIdInconformidadAuxiliares();
                    incAuxAuxiliarListNewIncAuxAuxiliar.setIdInconformidadAuxiliares(inconformidadAuxiliares);
                    incAuxAuxiliarListNewIncAuxAuxiliar = em.merge(incAuxAuxiliarListNewIncAuxAuxiliar);
                    if (oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar != null && !oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar.equals(inconformidadAuxiliares)) {
                        oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar.getIncAuxAuxiliarList().remove(incAuxAuxiliarListNewIncAuxAuxiliar);
                        oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar = em.merge(oldIdInconformidadAuxiliaresOfIncAuxAuxiliarListNewIncAuxAuxiliar);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListOrphanCheckIncAuxAuxiliar : incAuxAuxiliarListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This InconformidadAuxiliares (" + inconformidadAuxiliares + ") cannot be destroyed since the IncAuxAuxiliar " + incAuxAuxiliarListOrphanCheckIncAuxAuxiliar + " in its incAuxAuxiliarList field has a non-nullable idInconformidadAuxiliares field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
