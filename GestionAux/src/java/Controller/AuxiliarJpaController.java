    ...
    public void create(Auxiliar auxiliar) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListSeleccionAuxiliaresToAttach : auxiliar.getSeleccionAuxiliaresList()) {
                seleccionAuxiliaresListSeleccionAuxiliaresToAttach = em.getReference(seleccionAuxiliaresListSeleccionAuxiliaresToAttach.getClass(), seleccionAuxiliaresListSeleccionAuxiliaresToAttach.getSeleccionAuxiliaresId());
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListIncAuxAuxiliarToAttach : auxiliar.getIncAuxAuxiliarList()) {
                incAuxAuxiliarListIncAuxAuxiliarToAttach = em.getReference(incAuxAuxiliarListIncAuxAuxiliarToAttach.getClass(), incAuxAuxiliarListIncAuxAuxiliarToAttach.getIncAuxAuxiliarId());
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListAuxCumplimientoActividadesToAttach : auxiliar.getAuxCumplimientoActividadesList()) {
                auxCumplimientoActividadesListAuxCumplimientoActividadesToAttach = em.getReference(auxCumplimientoActividadesListAuxCumplimientoActividadesToAttach.getClass(), auxCumplimientoActividadesListAuxCumplimientoActividadesToAttach.getAuxCumpActividadesId());
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListSeleccionAuxiliares : auxiliar.getSeleccionAuxiliaresList()) {
                Auxiliar oldIdAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares = seleccionAuxiliaresListSeleccionAuxiliares.getIdAuxiliares();
                seleccionAuxiliaresListSeleccionAuxiliares.setIdAuxiliares(auxiliar);
                seleccionAuxiliaresListSeleccionAuxiliares = em.merge(seleccionAuxiliaresListSeleccionAuxiliares);
                if (oldIdAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares != null) {
                    oldIdAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares.getSeleccionAuxiliaresList().remove(seleccionAuxiliaresListSeleccionAuxiliares);
                    oldIdAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares = em.merge(oldIdAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares);
                }
            }
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListIncAuxAuxiliar : auxiliar.getIncAuxAuxiliarList()) {
                Auxiliar oldIdAuxiliarOfIncAuxAuxiliarListIncAuxAuxiliar = incAuxAuxiliarListIncAuxAuxiliar.getIdAuxiliar();
                incAuxAuxiliarListIncAuxAuxiliar.setIdAuxiliar(auxiliar);
                incAuxAuxiliarListIncAuxAuxiliar = em.merge(incAuxAuxiliarListIncAuxAuxiliar);
                if (oldIdAuxiliarOfIncAuxAuxiliarListIncAuxAuxiliar != null) {
                    oldIdAuxiliarOfIncAuxAuxiliarListIncAuxAuxiliar.getIncAuxAuxiliarList().remove(incAuxAuxiliarListIncAuxAuxiliar);
                    oldIdAuxiliarOfIncAuxAuxiliarListIncAuxAuxiliar = em.merge(oldIdAuxiliarOfIncAuxAuxiliarListIncAuxAuxiliar);
                }
            }
            for (AuxCumplimientoActividades auxCumplimientoActividadesListAuxCumplimientoActividades : auxiliar.getAuxCumplimientoActividadesList()) {
                Auxiliar oldIdAuxiliarOfAuxCumplimientoActividadesListAuxCumplimientoActividades = auxCumplimientoActividadesListAuxCumplimientoActividades.getIdAuxiliar();
                auxCumplimientoActividadesListAuxCumplimientoActividades.setIdAuxiliar(auxiliar);
                ...
                if (oldIdAuxiliarOfAuxCumplimientoActividadesListAuxCumplimientoActividades != null) {
                    oldIdAuxiliarOfAuxCumplimientoActividadesListAuxCumplimientoActividades.getAuxCumplimientoActividadesList().remove(auxCumplimientoActividadesListAuxCumplimientoActividades);
                    oldIdAuxiliarOfAuxCumplimientoActividadesListAuxCumplimientoActividades = em.merge(oldIdAuxiliarOfAuxCumplimientoActividadesListAuxCumplimientoActividades);
                }
            }
        ...
        try {
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListOldSeleccionAuxiliares : seleccionAuxiliaresListOld) {
                if (!seleccionAuxiliaresListNew.contains(seleccionAuxiliaresListOldSeleccionAuxiliares)) {
                    ...
                    illegalOrphanMessages.add("You must retain SeleccionAuxiliares " + seleccionAuxiliaresListOldSeleccionAuxiliares + " since its idAuxiliares field is not nullable.");
                }
            }
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListOldIncAuxAuxiliar : incAuxAuxiliarListOld) {
                if (!incAuxAuxiliarListNew.contains(incAuxAuxiliarListOldIncAuxAuxiliar)) {
                    ...
                    illegalOrphanMessages.add("You must retain IncAuxAuxiliar " + incAuxAuxiliarListOldIncAuxAuxiliar + " since its idAuxiliar field is not nullable.");
                }
            }
            for (AuxCumplimientoActividades auxCumplimientoActividadesListOldAuxCumplimientoActividades : auxCumplimientoActividadesListOld) {
                if (!auxCumplimientoActividadesListNew.contains(auxCumplimientoActividadesListOldAuxCumplimientoActividades)) {
                    ...
                    illegalOrphanMessages.add("You must retain AuxCumplimientoActividades " + auxCumplimientoActividadesListOldAuxCumplimientoActividades + " since its idAuxiliar field is not nullable.");
                }
            }
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListNewSeleccionAuxiliaresToAttach : seleccionAuxiliaresListNew) {
                seleccionAuxiliaresListNewSeleccionAuxiliaresToAttach = em.getReference(seleccionAuxiliaresListNewSeleccionAuxiliaresToAttach.getClass(), seleccionAuxiliaresListNewSeleccionAuxiliaresToAttach.getSeleccionAuxiliaresId());
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListNewIncAuxAuxiliarToAttach : incAuxAuxiliarListNew) {
                incAuxAuxiliarListNewIncAuxAuxiliarToAttach = em.getReference(incAuxAuxiliarListNewIncAuxAuxiliarToAttach.getClass(), incAuxAuxiliarListNewIncAuxAuxiliarToAttach.getIncAuxAuxiliarId());
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListNewAuxCumplimientoActividadesToAttach : auxCumplimientoActividadesListNew) {
                auxCumplimientoActividadesListNewAuxCumplimientoActividadesToAttach = em.getReference(auxCumplimientoActividadesListNewAuxCumplimientoActividadesToAttach.getClass(), auxCumplimientoActividadesListNewAuxCumplimientoActividadesToAttach.getAuxCumpActividadesId());
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListNewSeleccionAuxiliares : seleccionAuxiliaresListNew) {
                if (!seleccionAuxiliaresListOld.contains(seleccionAuxiliaresListNewSeleccionAuxiliares)) {
                    Auxiliar oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares = seleccionAuxiliaresListNewSeleccionAuxiliares.getIdAuxiliares();
                    seleccionAuxiliaresListNewSeleccionAuxiliares.setIdAuxiliares(auxiliar);
                    seleccionAuxiliaresListNewSeleccionAuxiliares = em.merge(seleccionAuxiliaresListNewSeleccionAuxiliares);
                    if (oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares != null && !oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares.equals(auxiliar)) {
                        oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares.getSeleccionAuxiliaresList().remove(seleccionAuxiliaresListNewSeleccionAuxiliares);
                        oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares = em.merge(oldIdAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares);
                    }
                }
            }
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListNewIncAuxAuxiliar : incAuxAuxiliarListNew) {
                if (!incAuxAuxiliarListOld.contains(incAuxAuxiliarListNewIncAuxAuxiliar)) {
                    Auxiliar oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar = incAuxAuxiliarListNewIncAuxAuxiliar.getIdAuxiliar();
                    incAuxAuxiliarListNewIncAuxAuxiliar.setIdAuxiliar(auxiliar);
                    incAuxAuxiliarListNewIncAuxAuxiliar = em.merge(incAuxAuxiliarListNewIncAuxAuxiliar);
                    if (oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar != null && !oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar.equals(auxiliar)) {
                        oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar.getIncAuxAuxiliarList().remove(incAuxAuxiliarListNewIncAuxAuxiliar);
                        oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar = em.merge(oldIdAuxiliarOfIncAuxAuxiliarListNewIncAuxAuxiliar);
                    }
                }
            }
            for (AuxCumplimientoActividades auxCumplimientoActividadesListNewAuxCumplimientoActividades : auxCumplimientoActividadesListNew) {
                if (!auxCumplimientoActividadesListOld.contains(auxCumplimientoActividadesListNewAuxCumplimientoActividades)) {
                    Auxiliar oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades = auxCumplimientoActividadesListNewAuxCumplimientoActividades.getIdAuxiliar();
                    auxCumplimientoActividadesListNewAuxCumplimientoActividades.setIdAuxiliar(auxiliar);
                    ...
                    if (oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades != null && !oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades.equals(auxiliar)) {
                        oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades.getAuxCumplimientoActividadesList().remove(auxCumplimientoActividadesListNewAuxCumplimientoActividades);
                        oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades = em.merge(oldIdAuxiliarOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades);
                    }
                }
            }
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListOrphanCheckSeleccionAuxiliares : seleccionAuxiliaresListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Auxiliar (" + auxiliar + ") cannot be destroyed since the SeleccionAuxiliares " + seleccionAuxiliaresListOrphanCheckSeleccionAuxiliares + " in its seleccionAuxiliaresList field has a non-nullable idAuxiliares field.");
            }
            ...
            for (IncAuxAuxiliar incAuxAuxiliarListOrphanCheckIncAuxAuxiliar : incAuxAuxiliarListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Auxiliar (" + auxiliar + ") cannot be destroyed since the IncAuxAuxiliar " + incAuxAuxiliarListOrphanCheckIncAuxAuxiliar + " in its incAuxAuxiliarList field has a non-nullable idAuxiliar field.");
            }
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListOrphanCheckAuxCumplimientoActividades : auxCumplimientoActividadesListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Auxiliar (" + auxiliar + ") cannot be destroyed since the AuxCumplimientoActividades " + auxCumplimientoActividadesListOrphanCheckAuxCumplimientoActividades + " in its auxCumplimientoActividadesList field has a non-nullable idAuxiliar field.");
            }
