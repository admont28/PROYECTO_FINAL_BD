...
public class EvaluacionAuxiliaresJpaController implements Serializable {
    ...
    public void create(EvaluacionAuxiliares evaluacionAuxiliares) throws IllegalOrphanException, PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListSeleccionAuxiliares : evaluacionAuxiliares.getSeleccionAuxiliaresList()) {
                EvaluacionAuxiliares oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares = seleccionAuxiliaresListSeleccionAuxiliares.getIdEvaluacionAuxiliares();
                seleccionAuxiliaresListSeleccionAuxiliares.setIdEvaluacionAuxiliares(evaluacionAuxiliares);
                seleccionAuxiliaresListSeleccionAuxiliares = em.merge(seleccionAuxiliaresListSeleccionAuxiliares);
                if (oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares != null) {
                    oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares.getSeleccionAuxiliaresList().remove(seleccionAuxiliaresListSeleccionAuxiliares);
                    oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares = em.merge(oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListSeleccionAuxiliares);
                }
            }
        ...
        try {
            ...
            for (SeleccionAuxiliares seleccionAuxiliaresListOldSeleccionAuxiliares : seleccionAuxiliaresListOld) {
                if (!seleccionAuxiliaresListNew.contains(seleccionAuxiliaresListOldSeleccionAuxiliares)) {
                    seleccionAuxiliaresListOldSeleccionAuxiliares.setIdEvaluacionAuxiliares(null);
                    seleccionAuxiliaresListOldSeleccionAuxiliares = em.merge(seleccionAuxiliaresListOldSeleccionAuxiliares);
                }
            }
            for (SeleccionAuxiliares seleccionAuxiliaresListNewSeleccionAuxiliares : seleccionAuxiliaresListNew) {
                if (!seleccionAuxiliaresListOld.contains(seleccionAuxiliaresListNewSeleccionAuxiliares)) {
                    EvaluacionAuxiliares oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares = seleccionAuxiliaresListNewSeleccionAuxiliares.getIdEvaluacionAuxiliares();
                    seleccionAuxiliaresListNewSeleccionAuxiliares.setIdEvaluacionAuxiliares(evaluacionAuxiliares);
                    seleccionAuxiliaresListNewSeleccionAuxiliares = em.merge(seleccionAuxiliaresListNewSeleccionAuxiliares);
                    if (oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares != null && !oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares.equals(evaluacionAuxiliares)) {
                        oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares.getSeleccionAuxiliaresList().remove(seleccionAuxiliaresListNewSeleccionAuxiliares);
                        oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares = em.merge(oldIdEvaluacionAuxiliaresOfSeleccionAuxiliaresListNewSeleccionAuxiliares);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            List<SeleccionAuxiliares> seleccionAuxiliaresList = evaluacionAuxiliares.getSeleccionAuxiliaresList();
            for (SeleccionAuxiliares seleccionAuxiliaresListSeleccionAuxiliares : seleccionAuxiliaresList) {
                seleccionAuxiliaresListSeleccionAuxiliares.setIdEvaluacionAuxiliares(null);
                seleccionAuxiliaresListSeleccionAuxiliares = em.merge(seleccionAuxiliaresListSeleccionAuxiliares);
            }
