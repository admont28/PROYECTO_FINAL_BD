    ...
    public void create(CumplimientoActividades cumplimientoActividades) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListAuxCumplimientoActividades : cumplimientoActividades.getAuxCumplimientoActividadesList()) {
                CumplimientoActividades oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListAuxCumplimientoActividades = auxCumplimientoActividadesListAuxCumplimientoActividades.getIdCumplimientoActividades();
                auxCumplimientoActividadesListAuxCumplimientoActividades.setIdCumplimientoActividades(cumplimientoActividades);
                ...
                if (oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListAuxCumplimientoActividades != null) {
                    oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListAuxCumplimientoActividades.getAuxCumplimientoActividadesList().remove(auxCumplimientoActividadesListAuxCumplimientoActividades);
                    oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListAuxCumplimientoActividades = em.merge(oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListAuxCumplimientoActividades);
                }
            }
        ...
        try {
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListOldAuxCumplimientoActividades : auxCumplimientoActividadesListOld) {
                if (!auxCumplimientoActividadesListNew.contains(auxCumplimientoActividadesListOldAuxCumplimientoActividades)) {
                    ...
                    illegalOrphanMessages.add("You must retain AuxCumplimientoActividades " + auxCumplimientoActividadesListOldAuxCumplimientoActividades + " since its idCumplimientoActividades field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListNewAuxCumplimientoActividades : auxCumplimientoActividadesListNew) {
                if (!auxCumplimientoActividadesListOld.contains(auxCumplimientoActividadesListNewAuxCumplimientoActividades)) {
                    CumplimientoActividades oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades = auxCumplimientoActividadesListNewAuxCumplimientoActividades.getIdCumplimientoActividades();
                    auxCumplimientoActividadesListNewAuxCumplimientoActividades.setIdCumplimientoActividades(cumplimientoActividades);
                    ...
                    if (oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades != null && !oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades.equals(cumplimientoActividades)) {
                        oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades.getAuxCumplimientoActividadesList().remove(auxCumplimientoActividadesListNewAuxCumplimientoActividades);
                        oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades = em.merge(oldIdCumplimientoActividadesOfAuxCumplimientoActividadesListNewAuxCumplimientoActividades);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (AuxCumplimientoActividades auxCumplimientoActividadesListOrphanCheckAuxCumplimientoActividades : auxCumplimientoActividadesListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This CumplimientoActividades (" + cumplimientoActividades + ") cannot be destroyed since the AuxCumplimientoActividades " + auxCumplimientoActividadesListOrphanCheckAuxCumplimientoActividades + " in its auxCumplimientoActividadesList field has a non-nullable idCumplimientoActividades field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
