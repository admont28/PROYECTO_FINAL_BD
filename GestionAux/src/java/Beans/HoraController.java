...
public class HoraController implements Serializable {
    ...
    private HoraJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new HoraJpaController(Persistence.createEntityManagerFactory("GestionAuxPU"));
        }
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getHoraId());
    ...
    public static class HoraControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Hora) {
                Hora o = (Hora) object;
                return getStringKey(o.getHoraId());
            } else {
